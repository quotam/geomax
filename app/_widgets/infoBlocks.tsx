		...
		<section className="mt-32 sm:mt-16" id="about">
			<div className="container md:px-8 flex justify-between  items-center md:flex-wrap md:gap-y-9">
				<div className="flex flex-col gap-7 mr-16 md:mr-0">
					...
					<p>
						Мы — динамично развивающаяся компания нового типа, команда с инновационным мышлением и свежим
						взглядом на управление растениеводством. Наша цель — разрушить устоявшиеся стереотипы о
						сельском хозяйстве и создать новую формацию в этой сфере.
					</p>
					<p>
						В GPSAGRO мы активно внедряем современные цифровые технологии, следуя последним тенденциям и
						постоянно повышая уровень профессионализма. Мы понимаем, что наши преимущества основаны на
						знании, опыте и безупречной деловой репутации.{' '}
					</p>{' '}
					<p>
						Специализируясь на продаже и установке высокоточных цифровых систем для сельского хозяйства,
						мы стремимся сделать ваш бизнес более эффективным и устойчивым. Присоединяйтесь к нам на пути
						к инновационному будущему в агросекторе!{' '}
					</p>
				</div>
				<div>
					<InfoBlock
