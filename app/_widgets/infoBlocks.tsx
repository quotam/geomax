			...
			<section className="mt-16">
				<div className="container flex justify-between items-center">
					<div className="flex flex-col gap-7 mr-16">
						...
						<p>
							Мы — динамично развивающаяся компания нового типа, команда с
							инновационным мышлением и свежим взглядом на управление растениеводством.
							Наша цель — разрушить устоявшиеся стереотипы о сельском хозяйстве и
							создать новую формацию в этой сфере.
						</p>
						<p>
					...
					<div className="mt-16 ml-12">
						...
						<InfoBlock
							...
							data={{
								title: 'Осуществляем \n поддержку',
								desc:
									'на весь период работы оборудования. Даем гарантию на все работы.',
								link: 'Задать вопрос',
								href: '/?form=1'
							}}
						/>
