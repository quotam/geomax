...
export default function OrderButt({
	productId: product,
	className,
	icon = true
}: {
	...
	return (
		<>
			<Button onClick={() => setOpen(true)} className={cn('font-bold flex-1 h-full', className)}>
				Заказать {icon && <ShoppingCart className="ml-2 size-4" strokeWidth={2.4} />}
			</Button>
			<SuperModal
				open={open}
				style={{
