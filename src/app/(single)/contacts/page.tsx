...
export const metadata: Metadata = {
	title: 'Контакты',
	description: 'Контакты нашей компании, свяжитесь с нами и получите консультацию'
}

const ContactPage = () => {
	return (
		<main className="flex-grow container px-4 py-20 sm:p-0">
			<h1 className="text-3xl sm:text-2xl font-bold mb-12 text-center">Контакты</h1>
