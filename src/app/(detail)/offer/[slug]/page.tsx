...
import { getDetailOfferService, getOffersListService } from '@front/entities/offer/server'
...
export async function generateMetadata({ params }: { params: PageParams }) {
	...
	const article = await getDetailOfferService.exec(slug)
...
export default async function ProjectPage({ params }: { params: PageParams }) {
	...
	const data = await getDetailOfferService.exec(slug)
