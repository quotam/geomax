...
const Coverage = () => {
	return (
		<section id="coverage">
			<div className="container overflow-hidden py-35 flex items-center md:flex-col md:gap-18 xs:gap-8 justify-between sm:pt-16 xs:pt-0">
				...
				<div className="px-8  w-2/5 md:p-0 md:w-full flex flex-col gap-9 md:px-2">
					<h4 className="text-heading sm:text-2xl  font-bold">
